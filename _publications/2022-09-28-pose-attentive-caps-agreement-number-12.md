...
citation: 'Özcan, B., Kınlı, F., & Kıraç, F. (2023). Generalization to unseen viewpoint images of objects via alleviated pose attentive capsule agreement. Neural Computing and Applications, 35(4), 3521-3536.'
---
...
@article{ozcan2023generalization,
  title={Generalization to unseen viewpoint images of objects via alleviated pose attentive capsule agreement},
  author={{\"O}zcan, Bar{\i}{\c{s}} and K{\i}nl{\i}, Furkan and K{\i}ra{\c{c}}, Furkan},
